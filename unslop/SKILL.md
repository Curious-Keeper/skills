---
name: unslop
description: Cut AI tells from writing. Use whenever drafting or editing prose a human reads, and before delivering any document, comment, commit message, or report.
---
...
One exemption runs through every word-choice rule below. A proper noun, or a term the project
defines and reuses on purpose, is vocabulary rather than slop. A repo named `sprint-harness`,
a glossary entry like **leverage**, a coined phrase like "the interface is the test surface":
these are load-bearing and renaming them costs more than the metaphor does. Check whether the
project defines the word before replacing it.
